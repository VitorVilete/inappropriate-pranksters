...
public class InterviewedPersonVisual : MonoBehaviour
{
    private bool isPlaying = false;
    private const string IS_PLAYING = "IS_PLAYING";
    [SerializeField] Animator interviewedPersonAnimator;
    ...
    private void MinigameManager_OnStateChanged(object sender, System.EventArgs e)
    {
        ...
        interviewedPersonAnimator.SetBool(IS_PLAYING, isPlaying);
    }
}
